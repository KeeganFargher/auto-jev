...
export function createDuelSetup(seed: number, teamAPicksByHero: LabPicksByHero = new Map()): BattleSetup {
  return {
    rulesetId: "duel",
    rulesetVersion: 1,
    seed,
    arenaId: boardArena.id,
    units: [...teamUnits("A", DUEL_TEAM_A, "south", teamAPicksByHero), ...teamUnits("B", DUEL_TEAM_B, "north")],
  };
}
